<div>
    <x-cms.page-header title="Reference map" description="Editable rich-text content of the public Reference Map page.">
        <x-slot:actions>
            <x-cms.button variant="secondary" href="{{ url('/id/refrencemap') }}" target="_blank">View page</x-cms.button>
