<div>
    <x-cms.page-header title="Downloads page" description="Editable rich-text content of the public Downloads page.">
        <x-slot:actions>
            <x-cms.button variant="secondary" href="{{ url('/id/downloads') }}" target="_blank">View page</x-cms.button>
