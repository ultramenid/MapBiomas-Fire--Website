<div>
    <x-cms.page-header title="Terms of use" description="Editable rich-text content of the public Terms of Use page.">
        <x-slot:actions>
            <x-cms.button variant="secondary" href="{{ url('/id/termsofuse') }}" target="_blank">View page</x-cms.button>
